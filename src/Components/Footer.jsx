  ...
  return (
    ...
    <div className="mx-auto  xl:px-0 lg:px-0 sm:px-0 px-0 bg-gradient-to-b from-slate-300 to-blue-200 shadow-2xl shadow-black py-2 ">
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8 mb-5">
          {/* <p className="hover:text-gray-500 text-base cursor-pointer leading-4 text-gray-600">About</p> */}
          <HashLink slot to='/#contact'>
            <p className="hover:text-gray-500 text-lg font-semibold cursor-pointer leading-4 text-gray-600">Contact us</p>
          </HashLink>
          <p className="hover:text-gray-500 text-lg font-semibold cursor-pointer leading-4 text-gray-600">Terms of Service</p>
          <p className="hover:text-gray-500 text-lg font-semibold cursor-pointer leading-4 text-gray-600">Privacy Policy</p>
        </div>
        ...
        <div className="flex items-center mt-6 mb-4">
          <p className="text-lg font-bold leading-4 text-gray-600">
            2025 <span className="font-semibold">Festivida</span>
          </p>
          <div className="border-l border-gray-600 pl-2 ml-2">
            <p className="text-lg font-semibold leading-4 text-gray-600">Inc. All rights reserved</p>
          </div>
        </div>
      </div>
    </div>
